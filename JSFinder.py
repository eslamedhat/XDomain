...
def find_by_url(url, js = False):
    if js == False:
        try:
            print("Searching for subdomains in:" + url)
        except:
...
def giveresult(urls, domian):
    ...
    print("\nFound " + str(len(subdomains)) + " Subdomain:")
    for subdomain in subdomains:
        content_subdomain += subdomain + "\n"
        #print(subdomain)
        target="http://" + subdomain
        print("checking if they are up and adding them to live.txt")
        try:
